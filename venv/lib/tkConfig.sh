...
# installed.
TK_PREFIX='/Users/priyansh/dev/python/playground/venv'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/priyansh/dev/python/playground/venv'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/priyansh/dev/python/playground/venv/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/priyansh/dev/python/playground/venv/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/priyansh/dev/python/playground/venv/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/priyansh/dev/python/playground/venv/lib/libtkstub8.6.a'
